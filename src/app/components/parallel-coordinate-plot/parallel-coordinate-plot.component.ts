...
@Component({
  selector: 'app-parallel-coordinate-plot',
  templateUrl: './parallel-coordinate-plot.component.html',
  styleUrls: ['./parallel-coordinate-plot.component.css']
})
export class ParallelCoordinatePlotComponent implements OnInit {
  app: any;
  doc: any;
  customizationInfo: any;
  webPlayerServerRootUrl = 'https://spotfire-next.cloud.tibco.com/spotfire/wp/';
  analysisPath = '/Users/65lovzvf3qjlpqanhwhgpcngqbz2orzh/BaseballPlayerData/parallel-coordinate-plot';
  parameters = '';
