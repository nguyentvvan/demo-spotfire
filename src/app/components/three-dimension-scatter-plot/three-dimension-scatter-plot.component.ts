...
@Component({
  selector: 'app-three-dimension-scatter-plot',
  templateUrl: './three-dimension-scatter-plot.component.html',
  styleUrls: ['./three-dimension-scatter-plot.component.css']
})
export class ThreeDimensionScatterPlotComponent implements OnInit {
  app: any;
  doc: any;
