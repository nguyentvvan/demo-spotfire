...
@Component({
  selector: 'app-spotfire-cross-table',
  templateUrl: './spotfire-cross-table.component.html',
  styleUrls: ['./spotfire-cross-table.component.css']
})
export class SpotfireCrossTableComponent implements OnInit {
  app: any;
  doc: any;
  customizationInfo: any;
  webPlayerServerRootUrl = 'https://spotfire-next.cloud.tibco.com/spotfire/wp/';
  analysisPath = '/Users/65lovzvf3qjlpqanhwhgpcngqbz2orzh/BaseballPlayerData/cross-table';
  parameters = '';
